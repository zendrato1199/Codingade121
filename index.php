...
<head>
    ...
    <style type="text/css">
        ...
        .bg::before {
            content: '';
            background-image: url('./asset/img/depan.jpg');
                ...
                <div class="card-panel z-depth-2" id="login">
                    ...
                    <div class="col s12">
                        <div class="card-content">
                            <h5 class="center" id="title">Administrasi | <b>YBM</b></h5>
                            <?php echo '<img id="logo" src="https://learnbookme.files.wordpress.com/2017/01/policy.png?w=730?w=300'.$data['logo'].'">';?>
                    ...
                    <form class="col s12 m12 offset-4 offset-4" method="POST" action="" >
                        ...
                        <div class="input-field col s12">
                            <button type="submit" class="btn-large waves-effect waves-light orange-grey col s12" name="submit">MASUK</button>
                        </div>
                    </form>
                    <!-- Form END -->
                    <?php
