                                ...
                                if(!preg_match("/^[a-zA-Z0-9., ]*$/", $nkode)){
                                    ...
                                    if(!preg_match("/^[a-zA-Z0-9., -]*$/", $indeks)){
                                        ...
                                        if(!preg_match("/^[a-zA-Z0-9.,()\/ -]*$/", $keterangan)){
                                                $_SESSION['jra'] = 'Form jra hanya boleh mengandung karakter huruf, angka, spasi, titik(.), koma(,), minus(-), garis miring(/), dan kurung()';
                                                echo '<script language="javascript">window.history.back();</script>';
                    ...
                    <div class="row">
                        ...
                        <div class="input-field col s6">
                            ...
                            <input id="keterangan" type="text" class="validate" name="keterangan" required>
                                ...
                                ?>
                            <label for="jra">JRA</label>
                        </div>
                        <div class="input-field col s6">
                            <i class="material-icons prefix md-prefix">featured_play_list</i>
                            <input id="jra" type="text" class="validate" name="jra" required>
                                <?php
                                    if(isset($_SESSION['jra'])){
                                        $keterangan = $_SESSION['jra'];
                                        echo '<div id="alert-message" class="callout bottom z-depth-1 red lighten-4 red-text">'.$jra.'</div>';
                                        unset($_SESSION['jra']);
                                    }
                                ?>
