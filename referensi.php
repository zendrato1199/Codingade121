                                    ...
                                    <div class="col m7">
                                        <ul class="left">
                                            ...
                                            if($_SESSION['admin'] == 1 || $_SESSION['admin'] == 2){
                                                echo '<li class="waves-effect waves-light"><a href="?page=ref&act=addsm"><i class="material-icons md-12">add_circle</i> Add Masuk</a></li>
                                                <li class="waves-effect waves-light"><a href="?page=ref&act=addsk"><i class="material-icons md-12">add_circle</i> Add Keluar</a></li>
                                                <li class="waves-effect waves-light"><a href="?page=ref&act=imp"><i class="material-icons md-12">file_upload</i> Import Data</a></li>';
                                            } else {
                                                echo '';
                                            } echo '
                                        </ul>
