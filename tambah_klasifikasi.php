                                ...
                                if(!preg_match("/^[a-zA-Z0-9., ]*$/", $nkode)){
                                    ...
                                    if(!preg_match("/^[0-9.-]*$/", $tgl_surat)){
                                        ...
                                        if(!preg_match("/^[a-zA-Z0-9.,()\/ -]*$/", $keterangan)){
                                            $_SESSION['jrak'] = 'Form Jra hanya boleh mengandung karakter huruf, angka, spasi, titik(.), koma(,), minus(-), garis miring(/), dan kurung()';
                                            echo '<script language="javascript">window.history.back();</script>';
                                    } else {
                            ...
                            <input id="jra" type="text" class="validate" name="jra" required>
                                <?php
                                    if(isset($_SESSION['keterangank'])){
                                        $keterangank = $_SESSION['jrak'];
                                        echo '<div id="alert-message" class="callout bottom z-depth-1 red lighten-4 red-text">'.$jrak.'</div>';
                                        unset($_SESSION['jrak']);
                                    }
                                ?>
